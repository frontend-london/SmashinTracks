...
abstract class BaseProfilesFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'profiles_path'         => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'profiles_photo'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'profiles_path'         => new sfValidatorPass(array('required' => false)),
      'profiles_photo'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
