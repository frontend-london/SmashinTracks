...
class ProfilesTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('PROFILES_NAME', 'ProfilesName', 'VARCHAR', true, 200, null);
		$this->addColumn('PROFILES_EMAIL', 'ProfilesEmail', 'VARCHAR', true, 200, null);
		$this->addColumn('PROFILES_PASSWORD', 'ProfilesPassword', 'VARCHAR', true, 32, null);
		...
		$this->addColumn('PROFILES_PHOTO_PATH', 'ProfilesPhotoPath', 'VARCHAR', false, 32, null);
    ...
    $this->addRelation('ProfilesViewedRelatedByArtistsId', 'ProfilesViewed', RelationMap::ONE_TO_MANY, array('profiles_id' => 'artists_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('ProfilesViewedRelatedByProfilesId', 'ProfilesViewed', RelationMap::ONE_TO_MANY, array('profiles_id' => 'profiles_id', ), 'RESTRICT', 'RESTRICT');
    ...
    $this->addRelation('TracksPlayed', 'TracksPlayed', RelationMap::ONE_TO_MANY, array('profiles_id' => 'profiles_id', ), 'RESTRICT', 'RESTRICT');
