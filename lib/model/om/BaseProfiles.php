...
abstract class BaseProfiles extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->profiles_sales_inform_instantly = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->profiles_sales_inform_daily = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->profiles_sales_inform_weekly = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->resetModified();
			...
			return $startcol + 16; // 16 = ProfilesPeer::NUM_COLUMNS - ProfilesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[13] => $this->getProfilesSalesInformInstantly(),
			$keys[14] => $this->getProfilesSalesInformDaily(),
			$keys[15] => $this->getProfilesSalesInformWeekly(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[13], $arr)) $this->setProfilesSalesInformInstantly($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setProfilesSalesInformDaily($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setProfilesSalesInformWeekly($arr[$keys[15]]);
	}
