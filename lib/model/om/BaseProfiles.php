...
abstract class BaseProfiles extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the profiles_photo_path field.
	 * @var        string
	 */
	protected $profiles_photo_path;
	...
	/**
	 * Get the [profiles_photo_path] column value.
	 * 
	 * @return     string
	 */
	public function getProfilesPhotoPath()
	{
		return $this->profiles_photo_path;
	}
	...
	/**
	 * Set the value of [profiles_photo_path] column.
	 * 
	 * @param      string $v new value
	 * @return     Profiles The current object (for fluent API support)
	 */
	public function setProfilesPhotoPath($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->profiles_photo_path !== $v) {
			$this->profiles_photo_path = $v;
			$this->modifiedColumns[] = ProfilesPeer::PROFILES_PHOTO_PATH;
		}

		return $this;
	} // setProfilesPhotoPath()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->profiles_photo_path = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->profiles_balance = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->profiles_blocked = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->profiles_deleted = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->profiles_password_url = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->profiles_newsletter = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->resetModified();
			...
			return $startcol + 12; // 12 = ProfilesPeer::NUM_COLUMNS - ProfilesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 5:
				...
				break;
			case 6:
				return $this->getProfilesPhotoPath();
				break;
			case 7:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getProfilesPhotoPath(),
			$keys[7] => $this->getProfilesBalance(),
			$keys[8] => $this->getProfilesBlocked(),
			$keys[9] => $this->getProfilesDeleted(),
			$keys[10] => $this->getProfilesPasswordUrl(),
			$keys[11] => $this->getProfilesNewsletter(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 5:
				...
				break;
			case 6:
				$this->setProfilesPhotoPath($value);
				break;
			case 7:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setProfilesPhotoPath($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setProfilesBalance($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setProfilesBlocked($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setProfilesDeleted($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setProfilesPasswordUrl($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setProfilesNewsletter($arr[$keys[11]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfilesPeer::PROFILES_PHOTO_PATH)) $criteria->add(ProfilesPeer::PROFILES_PHOTO_PATH, $this->profiles_photo_path);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setProfilesPhotoPath($this->profiles_photo_path);
