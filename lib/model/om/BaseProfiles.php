...
abstract class BaseProfiles extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the profiles_register_url field.
	 * @var        string
	 */
	protected $profiles_register_url;
	...
	/**
	 * The value for the profiles_sales_inform_instantly field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $profiles_sales_inform_instantly;

	/**
	 * The value for the profiles_sales_inform_daily field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $profiles_sales_inform_daily;

	/**
	 * The value for the profiles_sales_inform_weekly field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	protected $profiles_sales_inform_weekly;
	 ...
	 */
	protected $collProfilesVieweds;

	/**
	 * @var        Criteria The criteria used to select the current contents of collProfilesVieweds.
	 */
	private $lastProfilesViewedCriteria = null;
	...
	/**
	 * @var        array TracksVotes[] Collection to store aggregation of TracksVotes objects.
	 */
	protected $collTracksVotess;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTracksVotess.
	 */
	private $lastTracksVotesCriteria = null;
	...
	public function applyDefaultValues()
	{
		...
		$this->profiles_sales_inform_instantly = 0;
		$this->profiles_sales_inform_daily = 0;
		$this->profiles_sales_inform_weekly = 0;
	}
	...
	/**
	 * Get the [profiles_register_url] column value.
	 * 
	 * @return     string
	 */
	public function getProfilesRegisterUrl()
	{
		return $this->profiles_register_url;
	}
	...
	/**
	 * Get the [profiles_sales_inform_instantly] column value.
	 * 
	 * @return     int
	 */
	public function getProfilesSalesInformInstantly()
	{
		return $this->profiles_sales_inform_instantly;
	}

	/**
	 * Get the [profiles_sales_inform_daily] column value.
	 * 
	 * @return     int
	 */
	public function getProfilesSalesInformDaily()
	{
		return $this->profiles_sales_inform_daily;
	}

	/**
	 * Get the [profiles_sales_inform_weekly] column value.
	 * 
	 * @return     int
	 */
	public function getProfilesSalesInformWeekly()
	{
		return $this->profiles_sales_inform_weekly;
	}
	...
	/**
	 * Set the value of [profiles_register_url] column.
	 * 
	 * @param      string $v new value
	 * @return     Profiles The current object (for fluent API support)
	 */
	public function setProfilesRegisterUrl($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->profiles_register_url !== $v) {
			$this->profiles_register_url = $v;
			$this->modifiedColumns[] = ProfilesPeer::PROFILES_REGISTER_URL;
		}

		return $this;
	} // setProfilesRegisterUrl()
	...
	/**
	 * Set the value of [profiles_sales_inform_instantly] column.
	 * 
	 * @param      int $v new value
	 * @return     Profiles The current object (for fluent API support)
	 */
	public function setProfilesSalesInformInstantly($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->profiles_sales_inform_instantly !== $v || $this->isNew()) {
			$this->profiles_sales_inform_instantly = $v;
			$this->modifiedColumns[] = ProfilesPeer::PROFILES_SALES_INFORM_INSTANTLY;
		}

		return $this;
	} // setProfilesSalesInformInstantly()

	/**
	 * Set the value of [profiles_sales_inform_daily] column.
	 * 
	 * @param      int $v new value
	 * @return     Profiles The current object (for fluent API support)
	 */
	public function setProfilesSalesInformDaily($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->profiles_sales_inform_daily !== $v || $this->isNew()) {
			$this->profiles_sales_inform_daily = $v;
			$this->modifiedColumns[] = ProfilesPeer::PROFILES_SALES_INFORM_DAILY;
		}

		return $this;
	} // setProfilesSalesInformDaily()

	/**
	 * Set the value of [profiles_sales_inform_weekly] column.
	 * 
	 * @param      int $v new value
	 * @return     Profiles The current object (for fluent API support)
	 */
	public function setProfilesSalesInformWeekly($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->profiles_sales_inform_weekly !== $v || $this->isNew()) {
			$this->profiles_sales_inform_weekly = $v;
			$this->modifiedColumns[] = ProfilesPeer::PROFILES_SALES_INFORM_WEEKLY;
		}

		return $this;
	} // setProfilesSalesInformWeekly()
	...
	public function hasOnlyDefaultValues()
	{
			...
			if ($this->profiles_sales_inform_instantly !== 0) {
				return false;
			}

			if ($this->profiles_sales_inform_daily !== 0) {
				return false;
			}

			if ($this->profiles_sales_inform_weekly !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->profiles_register_url = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->profiles_password_url = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
			$this->profiles_newsletter = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			$this->profiles_sales_inform_instantly = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->profiles_sales_inform_daily = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->profiles_sales_inform_weekly = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
			$this->resetModified();
			...
			return $startcol + 17; // 17 = ProfilesPeer::NUM_COLUMNS - ProfilesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collProfilesVieweds = null;
			$this->lastProfilesViewedCriteria = null;
			...
			$this->collTracksVotess = null;
			$this->lastTracksVotesCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collProfilesVieweds !== null) {
				foreach ($this->collProfilesVieweds as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collTracksVotess !== null) {
				foreach ($this->collTracksVotess as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 10:
				...
				break;
			case 11:
				return $this->getProfilesRegisterUrl();
				break;
			case 12:
			...
			case 13:
				...
				break;
			case 14:
				return $this->getProfilesSalesInformInstantly();
				break;
			case 15:
				return $this->getProfilesSalesInformDaily();
				break;
			case 16:
				return $this->getProfilesSalesInformWeekly();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[11] => $this->getProfilesRegisterUrl(),
			$keys[12] => $this->getProfilesPasswordUrl(),
			$keys[13] => $this->getProfilesNewsletter(),
			$keys[14] => $this->getProfilesSalesInformInstantly(),
			$keys[15] => $this->getProfilesSalesInformDaily(),
			$keys[16] => $this->getProfilesSalesInformWeekly(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 10:
				...
				break;
			case 11:
				$this->setProfilesRegisterUrl($value);
				break;
			case 12:
			...
			case 13:
				...
				break;
			case 14:
				$this->setProfilesSalesInformInstantly($value);
				break;
			case 15:
				$this->setProfilesSalesInformDaily($value);
				break;
			case 16:
				$this->setProfilesSalesInformWeekly($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setProfilesRegisterUrl($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setProfilesPasswordUrl($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setProfilesNewsletter($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setProfilesSalesInformInstantly($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setProfilesSalesInformDaily($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setProfilesSalesInformWeekly($arr[$keys[16]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProfilesPeer::PROFILES_REGISTER_URL)) $criteria->add(ProfilesPeer::PROFILES_REGISTER_URL, $this->profiles_register_url);
		...
		if ($this->isColumnModified(ProfilesPeer::PROFILES_SALES_INFORM_INSTANTLY)) $criteria->add(ProfilesPeer::PROFILES_SALES_INFORM_INSTANTLY, $this->profiles_sales_inform_instantly);
		if ($this->isColumnModified(ProfilesPeer::PROFILES_SALES_INFORM_DAILY)) $criteria->add(ProfilesPeer::PROFILES_SALES_INFORM_DAILY, $this->profiles_sales_inform_daily);
		if ($this->isColumnModified(ProfilesPeer::PROFILES_SALES_INFORM_WEEKLY)) $criteria->add(ProfilesPeer::PROFILES_SALES_INFORM_WEEKLY, $this->profiles_sales_inform_weekly);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setProfilesRegisterUrl($this->profiles_register_url);

		$copyObj->setProfilesPasswordUrl($this->profiles_password_url);

		$copyObj->setProfilesNewsletter($this->profiles_newsletter);

		$copyObj->setProfilesSalesInformInstantly($this->profiles_sales_inform_instantly);

		$copyObj->setProfilesSalesInformDaily($this->profiles_sales_inform_daily);

		$copyObj->setProfilesSalesInformWeekly($this->profiles_sales_inform_weekly);
		...
		if ($deepCopy) {
			...
			foreach ($this->getProfilesVieweds() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addProfilesViewed($relObj->copy($deepCopy));
				}
			}
			...
			foreach ($this->getTracksVotess() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTracksVotes($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collProfilesVieweds collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addProfilesVieweds()
	 */
	public function clearProfilesVieweds()
	{
		$this->collProfilesVieweds = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collProfilesVieweds collection (array).
	 *
	 * By default this just sets the collProfilesVieweds collection to an empty array (like clearcollProfilesVieweds());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initProfilesVieweds()
	{
		$this->collProfilesVieweds = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Profiles has previously been saved, it will retrieve
	 * related ProfilesVieweds from storage. If this Profiles is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getProfilesVieweds($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilesPeer::DATABASE_NAME);
		}
		...
		if ($this->collProfilesVieweds === null) {
			if ($this->isNew()) {
			   $this->collProfilesVieweds = array();
				...
				$this->collProfilesVieweds = ProfilesViewedPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				ProfilesViewedPeer::addSelectColumns($criteria);
				if (!isset($this->lastProfilesViewedCriteria) || !$this->lastProfilesViewedCriteria->equals($criteria)) {
					$this->collProfilesVieweds = ProfilesViewedPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastProfilesViewedCriteria = $criteria;
		return $this->collProfilesVieweds;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countProfilesVieweds(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilesPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collProfilesVieweds === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastProfilesViewedCriteria) || !$this->lastProfilesViewedCriteria->equals($criteria)) {
					...
					$count = count($this->collProfilesVieweds);
				}
			} else {
				$count = count($this->collProfilesVieweds);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addProfilesViewed(ProfilesViewed $l)
	{
		if ($this->collProfilesVieweds === null) {
			$this->initProfilesVieweds();
		}
		if (!in_array($l, $this->collProfilesVieweds, true)) { // only add it if the **same** object is not already associated
			array_push($this->collProfilesVieweds, $l);
			$l->setProfiles($this);
		}
	}
	...
	/**
	 * Clears out the collTracksVotess collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addTracksVotess()
	 */
	public function clearTracksVotess()
	{
		$this->collTracksVotess = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTracksVotess collection (array).
	 *
	 * By default this just sets the collTracksVotess collection to an empty array (like clearcollTracksVotess());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTracksVotess()
	{
		$this->collTracksVotess = array();
	}

	/**
	 * Gets an array of TracksVotes objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Profiles has previously been saved, it will retrieve
	 * related TracksVotess from storage. If this Profiles is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array TracksVotes[]
	 * @throws     PropelException
	 */
	public function getTracksVotess($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilesPeer::DATABASE_NAME);
		}
		...
		if ($this->collTracksVotess === null) {
			if ($this->isNew()) {
			   $this->collTracksVotess = array();
				...
				$criteria->add(TracksVotesPeer::PROFILES_ID, $this->profiles_id);

				TracksVotesPeer::addSelectColumns($criteria);
				$this->collTracksVotess = TracksVotesPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TracksVotesPeer::addSelectColumns($criteria);
				if (!isset($this->lastTracksVotesCriteria) || !$this->lastTracksVotesCriteria->equals($criteria)) {
					$this->collTracksVotess = TracksVotesPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTracksVotesCriteria = $criteria;
		return $this->collTracksVotess;
	}

	/**
	 * Returns the number of related TracksVotes objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related TracksVotes objects.
	 * @throws     PropelException
	 */
	public function countTracksVotess(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilesPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTracksVotess === null) {
			if ($this->isNew()) {
				...
				$count = TracksVotesPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTracksVotesCriteria) || !$this->lastTracksVotesCriteria->equals($criteria)) {
					...
					$count = count($this->collTracksVotess);
				}
			} else {
				$count = count($this->collTracksVotess);
			}
	...
	/**
	 * Method called to associate a TracksVotes object to this object
	 * through the TracksVotes foreign key attribute.
	 *
	 * @param      TracksVotes $l TracksVotes
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTracksVotes(TracksVotes $l)
	{
		if ($this->collTracksVotess === null) {
			$this->initTracksVotess();
		}
		if (!in_array($l, $this->collTracksVotess, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTracksVotess, $l);
			$l->setProfiles($this);
		}
	}
	 ...
	 * Otherwise if this Profiles is new, it will return
	 * an empty collection; or if this Profiles has previously
	 * been saved, it will retrieve related TracksVotess from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Profiles.
	 */
	public function getTracksVotessJoinTracks($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ProfilesPeer::DATABASE_NAME);
		}
		...
		if ($this->collTracksVotess === null) {
			if ($this->isNew()) {
				...
				$this->collTracksVotess = TracksVotesPeer::doSelectJoinTracks($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collProfilesVieweds) {
				foreach ((array) $this->collProfilesVieweds as $o) {
					$o->clearAllReferences($deep);
				}
			}
			...
			if ($this->collTracksVotess) {
				foreach ((array) $this->collTracksVotess as $o) {
					$o->clearAllReferences($deep);
				}
			}
