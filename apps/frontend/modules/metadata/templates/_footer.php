...
?>
                <div id="box-footer<?if($border):?>-border<?endif;?>">
                    ...
                    <?if($facebook):?>
                        <div id="bf-facebook">
                            <iframe src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2Fpages%2FSmashin-Tracks%2F214164275274674&amp;width=531&amp;colorscheme=light&amp;show_faces=true&amp;stream=false&amp;header=false&amp;height=254" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:531px; height:254px;" allowTransparency="true"></iframe>
                        </div>
                    <?endif;?>
                    <div class="clear"></div>
                </div>       