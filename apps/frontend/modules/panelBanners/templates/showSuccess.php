                    ...
                    <div class="bs-inner">
                        <form action="<?php echo url_for('panel_banners') ?>" method="POST" id="form_banners_top" name="form_banners_top" enctype="multipart/form-data">
                            ...
                            <div id="bb2-div2">
                                ...
                                <div class="bm3-right">
                                    ...
                                    <div class="button-add">
                                        ...
                                        <span>Add</span>
                                        <input type="file" name="banners_top_image" class="file_input_hidden" onchange="javascript: document.getElementById('input_photo1').value = this.value" />
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <?foreach ($banners_top as $banner):?>
                                <div class="bb2-gorny-image">
                                    <input type="checkbox" name="banners_top_active_<?=$banner->getBannersId()?>" value="1" class="bb2-checkbox"<?if($banner->getBannersActive()):?> checked="checked"<?endif;?> />
                                    <a href="<?=url_for('panel_banners_delete', $banner)?>" class="track-bin2"></a>
                                    <img src="images/banners/<?=$banner->getBannersPath()?>.jpg" alt="" class="bb2-banner-top" />
                                </div>
                                <?if($banner==$active_banner):?>
                                    <div class="bb2-gorny-adres-new">
                                        ...
                                        <div class="bm3-right">
                                            ...
                                            <input type="hidden" name="banners_top_edit_action" id="banners_top_edit_action" value="0" />
                                            <div class="button-ok">
                                                <div class="button-left"></div>
                                                <div class="button-right"></div>
                                                <a id="a-banners-top-edit-submit" href="#">OK</a>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                        ...
                        <form action="<?php echo url_for('panel_banners') ?>" method="POST" id="form_banners_side" name="form_banners_side" enctype="multipart/form-data">
                            <div id="bb2-div6">
                                ...
                                <div class="bm3-right">
                                    <input type="text" class="input-290px" id="input_photo2" value="" />
                                    <div class="button-add">
                                        <div class="button-left"></div>
                                        <div class="button-right"></div>
                                        <span>Add</span>
                                        <input type="file" name="banners_side_image" class="file_input_hidden" onchange="javascript: document.getElementById('input_photo2').value = this.value" />
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <?$counter = 0; foreach($banners_side as $banner):?>
                                ...
                                <div class="bb2-boczny-image">
                                    <input type="checkbox" name="banners_side_active_<?=$banner->getBannersId()?>" value="1" class="bb2-checkbox"<?if($banner->getBannersActive()):?> checked="checked"<?endif;?> />
                                    <?if($banners_prev_id):?>
                                    ...
                                    <?endif;?>
                                    <a href="<?=url_for('panel_banners_delete', $banner)?>" class="track-bin2"></a>
                                    <img src="images/banners/<?=$banner->getBannersPath()?>.jpg" alt="" class="bb2-banner-right" />
                                </div>
                                <?if($banner==$active_banner):?>
                                    <div class="bb2-gorny-adres-new">
                                        <div class="bm3-left">Adres:</div>
                                        <div class="bm3-right">
                                            ...
                                            <input type="hidden" name="banners_side_edit_action" id="banners_side_edit_action" value="0" />
                                            <div class="button-ok">
                                                <div class="button-left"></div>
                                                <div class="button-right"></div>
                                                <a id="a-banners-side-edit-submit" href="#">OK</a>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
